...
export const useAlarmHandler = () => {
  ...
  useEffect(() => {
    const handleNewAlarms = async () => {
      ...
      const newAlarms = alerts.filter(alert => 
    ...
    handleNewAlarms();
  }, [alerts, sendAlarmNotification, getCurrentLocation, startLocationTracking, locationPermission, requestLocationPermissions]);
