    ...
    <div className="h-full bg-blue-50 overflow-y-auto">
      <div className="safe-area-pt">
        <div className="p-4 space-y-6 pb-20">
          ...
          <Collapsible open={openSections.artikel1} onOpenChange={() => toggleSection('artikel1')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 1: Algemene bepalingen
                    <span className="text-sm">{openSections.artikel1 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel2} onOpenChange={() => toggleSection('artikel2')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 2: Welke gegevens verwerkt Ouderen Alarm en waarvoor worden ze gebruikt?
                    <span className="text-sm">{openSections.artikel2 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel3} onOpenChange={() => toggleSection('artikel3')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 3: Duur van opslag
                    <span className="text-sm">{openSections.artikel3 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel4} onOpenChange={() => toggleSection('artikel4')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 4: Uw rechten onder de AVG
                    <span className="text-sm">{openSections.artikel4 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel5} onOpenChange={() => toggleSection('artikel5')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 5: Veiligheid & Derden
                    <span className="text-sm">{openSections.artikel5 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel6} onOpenChange={() => toggleSection('artikel6')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 6: Rechtsgrond voor verwerking
                    <span className="text-sm">{openSections.artikel6 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel7} onOpenChange={() => toggleSection('artikel7')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 7: Functionaris voor gegevensbescherming
                    <span className="text-sm">{openSections.artikel7 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <Collapsible open={openSections.artikel8} onOpenChange={() => toggleSection('artikel8')}>
            <Card>
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    Artikel 8: Wijzigingen in privacyverklaring
                    <span className="text-sm">{openSections.artikel8 ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
              ...
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50">
                  <CardTitle className="text-lg text-blue-600 flex items-center justify-between">
                    ...
                    <span className="text-sm">{openSections.cookies ? '−' : '+'}</span>
                  </CardTitle>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
          ...
          <div className="text-center text-xs text-gray-500 pt-4">
            <p>Dit privacybeleid voldoet aan de AVG (Algemene Verordening Gegevensbescherming) en Nederlandse wetgeving.</p>
            <p className="mt-1">Laatste update: 26 mei 2025</p>
          </div>
        </div>
      </div>
    </div>
